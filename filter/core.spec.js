...
describe('Filter', function() {
  describe('#onlyEven()', function () {
    xit('returns only those numbers that are even', function () {
  ...
  describe('#onlyOneWord()', function () {
    xit('returns only those strings with a single word (no spaces)', function () {
  ...
  describe('#positiveRowsOnly()', function () {
    xit('return only the rows in the matrix that have all positive integers', function () {
      var matrix = [[1, 10,-100],
                    [2,-20, 200],
                    [3, 30, 300]];
      var result = [[3, 30, 300]];
